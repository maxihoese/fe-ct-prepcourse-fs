...
function numeroMasGrande(arrayOfNums) {
   ...
   // Tu código:
   var arrayOfNumsOrdenados = arrayOfNums.sort(function(a, b) {
      return a - b;
   });
   return (arrayOfNumsOrdenados.at(-1));
}
...
function mesesDelAño(array) {
   ...
   var tresMeses = []
   for ( i=0; i<array.length; i++){
      if (array[i] == "Enero" || array[i] == "Marzo" || array[i] == "Noviembre") tresMeses.push(array[i]);
      }
